    ...
    else
    {
        ...
        else
        {
            ...
            case 0:
				...
				{
					Width = (float)GetScreenWidth() / 500.f; //Mientras mas chico sea el valor mas ancho es el triangulo negro (Creo que 640.f era el valor original, yo lo tengo 500.f)
				}
...
void RenderTerrainFrustrum(bool EditFlag)
{
    ...
    if (g_pTerrainShader) g_pTerrainShader->Use();
    ...
    if (g_pTerrainShader) g_pTerrainShader->Unuse();
}
