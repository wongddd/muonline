...
// ============================================================
// Compile-time validation: PROTOCOL_CODE must match client
// Client uses: PACKET_MOVE=0xD4, PACKET_ATTACK=0x11, PACKET_POSITION=0x15
// ============================================================
...
#pragma message("WARNING: Client uses PACKET_MOVE=0xD4, PACKET_ATTACK=0x11, PACKET_POSITION=0x15")
#endif
