...
namespace SEASON3B
{
	...
	protected:
		...
		static CNewUISystem* m_pInstance;
	...
	private:
		...
		CNewUICustomRanking*		m_pNewCustomRanking;
		CNewUICustomEventTime*		m_pNewCustomEventTime;
		CNewUICustomBuyVip*			m_pNewCustomBuyVip;
		CNewUICustomArena*			m_pNewCustomArena;
	...
	public:
		...
		CNewUICustomRanking* GetUI_NewCustomRanking() const;
		CNewUICustomEventTime* GetUI_NewCustomEventTime() const;
		CNewUICustomBuyVip* GetUI_NewCustomBuyVip() const;
		CNewUICustomArena* GetUI_NewCustomArena() const;
...
#define g_pNewUICustomRanking SEASON3B::CNewUISystem::GetInstance()->GetUI_NewCustomRanking()
#define g_pNewUICustomEventTime SEASON3B::CNewUISystem::GetInstance()->GetUI_NewCustomEventTime()
#define g_pNewUICustomBuyVip SEASON3B::CNewUISystem::GetInstance()->GetUI_NewCustomBuyVip()
#define g_pNewUICustomArena SEASON3B::CNewUISystem::GetInstance()->GetUI_NewCustomArena()
#ifdef LEM_ADD_LUCKYITEM
