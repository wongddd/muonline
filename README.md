...
详情见 [fix_log_v5.md](fix_log_v5.md)

### v6 修复内容

- **角色选取修复**: 角色画面点击 3D 模型可选中角色，修复声明签名不匹配和 `m_bIsSelected` 过滤逻辑
- **协议适配**: `SendRequestFinishLoading` 宏添加现代协议路径，卡 Loading 问题修复
- **断行字符串**: 修复 5 处断行字符串字面量编译错误

详情见 [fix_log_v6.md](fix_log_v6.md)
